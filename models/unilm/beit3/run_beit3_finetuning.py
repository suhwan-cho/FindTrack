...
def get_args():
    ...
    # Model parameters
    parser.add_argument('--evfsam', default='beit_base_patch16_224', type=str, metavar='MODEL',
                        help='Name of evfsam to train')
    ...
    parser.add_argument('--sentencepiece_model', type=str, required=True, 
                        help='Sentencepiece evfsam path for the pretrained evfsam.')
    ...
    parser.add_argument('--model_key', default='evfsam|module', type=str)
...
def main(args, ds_init):
    ...
    model_ema = None
    if args.model_ema:
        # Important to create EMA evfsam after cuda(), DP wrapper, and AMP but before SyncBN and DDP wrapper
        model_ema = ModelEma(
            model,
    ...
    if args.enable_deepspeed:
        ...
        print("evfsam.gradient_accumulation_steps() = %d" % model.gradient_accumulation_steps())
