...
def train():
    ...
    ann_file = os.path.join(root, 'meta_expressions', 'train', 'meta_expressions.json')
    dataset = YTVOSDataset(args=[], img_folder=img_folder, ann_file=ann_file, tf=ResizeLongestSide(1024),
    ...
    for epoch in range(1, max_epochs + 1):
        ...
        if rank == 0:
            ...
            save_path = os.path.join('weights/ytvos_{:04d}.pth'.format(epoch))
